...
<div class="w3-row">
	...
	<table class="table w3-hoverable w3-striped table-bordered">
		<thead>
		<tr class="w3-brown">
			<th>ID</th>
			<th width="30px"></th>
		...
		<tr class="@{{ model.DELETED_CSS_CLASS }}" ng-repeat="model in model_list">
			...
			<td><img ng-if="model.profile_picture != null" class="lazy" ng-src="@{{ '/upload/user/' + model.profile_picture}}" alt="" width="30px" ></td>
			<td>
