<div class="w3-bar w3-brown w3-border">
	...
	<a href="/customer" class="w3-bar-item w3-button {{ ($id == 'manage_customer') ? 'w3-gray' : ''}}"><i class="fa fa-address-card" aria-hidden="true"></i> 顧客</a>
	...
	@if ( in_array($logged_in_user->permission_flag, array("Owner", "Administrator", "Manager", "Member")) )
	<div class="w3-dropdown-hover w3-brown">
